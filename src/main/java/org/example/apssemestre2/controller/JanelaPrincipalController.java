...
public class JanelaPrincipalController implements Initializable {
	...
	public void initialize(URL url,ResourceBundle rb) {
		...
		*/
		...
		List<ContaLuz> contas = service.listar();

		if (!contas.isEmpty()) {
			ContaLuz primeiraConta = contas.get(0);
			TextFieldAnt.setText(primeiraConta.getValor());
			TextFieldFat.setText(primeiraConta.getVencimento());
