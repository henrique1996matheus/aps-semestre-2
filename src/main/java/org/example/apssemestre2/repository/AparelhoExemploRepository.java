...
public class AparelhoExemploRepository extends BaseRepository<Aparelho> {
    @Override
    ...
    @Override
    public void cadastrar(Aparelho entidade) {

    }

    @Override
    public void atualizar(Aparelho entidade) {

    }

    @Override
    public void excluir(Aparelho entidade) {
