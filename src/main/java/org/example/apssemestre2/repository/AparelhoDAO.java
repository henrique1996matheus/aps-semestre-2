...
public class AparelhoDAO {
    public void cadastraraAparelho(Aparelho aparelho){
    ...
    public void excluirAparelho(Aparelho aparelho) {
    ...
    public void alterarAparelhos(Aparelho aparelho){
    ...
    public static List<Aparelho> ListaAparelhos(){
